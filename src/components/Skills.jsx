...
function Skills({ isDarkMode }) {
  return (
    <div className={`skills py-16 px-8 ${isDarkMode ? 'dark-mode bg-gray-800' : ''}`}>
      ...
      <div className="skill-items flex gap-8">
        {/* Skill Box 1 */}
        <div className="item bg-blue-100 w-1/4 rounded-lg p-8 border-b-4 border-transparent cursor-pointer transition-all duration-300 hover:border-purple-600">
