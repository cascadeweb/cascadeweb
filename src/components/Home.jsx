...
function Home() {
  return (
    <div className="main bg-deebee px-8 py-16 flex items-center justify-between bg-blue-200">
      <div className="left">
        <h5 className="text-4xl font-bold mb-2">Hey, I am Cas</h5>
        <h3 className="text-6xl font-bold mb-6">I create <span className="text-purple-600">product design</span> and brand experience</h3>
